...
\begin{document}
	...
	%
	\author{ Rahhul J$^{*}$ %<-this  stops a space
...
\begin{lstlisting}
    $ wget https://github.com/rahhul17/EE3900_pingala/blob/main/codes/problem_1.py
\end{lstlisting}
\end{enumerate}
...
\begin{lstlisting}
    $ wget https://github.com/rahhul17/EE3900_pingala/blob/main/codes/problem_2-2.py
\end{lstlisting}
\begin{figure}[!ht]
	\centering
...
\begin{lstlisting}
    $ wget https://github.com/rahhul17/EE3900_pingala/blob/main/codes/problem_2-5.py
\end{lstlisting}
\begin{figure}[!ht]
	\centering
